...
const articles = [
  ...
  date: '2026-06-15',
    category: 'ROSTER MOVE',
    title: "God, Syria, Allar release a QB.",
    ...
    body: "The reigning CTE Bowl Champions have released backup QB Drew Lock, who was picked up just last month as a presumed training camp body for this team. \n\n Drew Lock goes back to being a free agent, and is likely to not be picked up by any team once he clears past waivers.",
    teamIds: [2],
  },
    {
    id: 4,
  date: '2026-06-30',
    category: 'NEWS',
    title: "Hongyuan Heishous GM: 'Draft Picks Are Better Than S*x.'",
    excerpt: 'After placing their second and fifth overall picks on the trade block.',
    image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRa6IlCoBnj-Udd5U6hAX9KEj1lMFvZxua9MjlxbEzYf1wR_6FFmZVGxhE&s=10',
    body: "The Hongyuan Heishous placed the second and fifth picks for this 2026 #CTESPN Rookie Draft. \n\n The Heishous' management, in a bid to attempt to persuade other GM's to trade for them. It's rumored other teams are interested in these picks, but only time can tell.",
    teamIds: [6],
  },
  {
    id: 5,
  date: '2026-06-30',
    category: 'TRADE',
    title: "BOMBSHELL: The InshallArtetaliban trade for the 2nd overall pick.",
    excerpt: 'The InshallArtetaliban and Hongyuan Heishous have agreed on a trade involving the second and fourth overall picks.',
    image: 'https://static.clubs.nfl.com/image/upload/t_landscape_tablet_2x/f_auto/saints/ylrmficej1jdueypghlv.jpg',
    body: "The Hongyuan Heishous placed the second overall pick on the trade block earlier this afternoon, with the InshallArtetaliban reportedly being the first to contact the Heishous to conclude this trade. \n In it, they sent New Orleans duo RB Travis Etienne and TE Juwan Johnson, as well as the fourth overall pick in the 2026 #CTESPN Draft. \n\n The InshallArtetaliban made the following statement: 'As an organization, we are eternally grateful for both of our players’ services. Juwan arrived as a waiver wire player, playing twice for the team, providing useful performances when needed as he made a top-10 TE finish this season. Travis Etienne was another player instrumental to our playoff success, not only propelling us to the Charlie Kirk Bowl, but also pitching in 15 points across both games to help us win it. Both players are cemented in Talibani history, and this organization wishes them the best of luck in their future endeavors. \n\n This trade was cleared and processed by July 2nd.",
    teamIds: [6, 8],
  },
  {
    id: 6,
  date: '2026-07-01',
    category: 'TRADE',
    title: "BOMBSHELL: The InshallArtetaliban trade for the 1st overall pick.",
    excerpt: 'The InshallArtetaliban and Scranton Silly Guys have agreed on a trade involving the first and seventh overall picks.',
    image: 'https://imageio.forbes.com/specials-images/imageserve/68d2ce513ff75a7205cb57e2/Ladd-McConkey/0x0.jpg?crop=3000%2C1687%2Cx0%2Cy51%2Csafe&width=960',
    body: "The InshallArtetaliban have traded with the Scranton Silly Guys, sending WR Ladd McConkey, the Denver Broncos DEF, and the 7th overall pick in the 2026 #CTESPN Draft for the 1st overall pick in the 2026 #CTESPN Draft. \n\n The move of Ladd McConkey, once considered 'untouchable' by the Talibani front office, comes as a surprise given they now possess the same number of wide receivers as they do quarterbacks (4). \n\n The Talibanis released the following statement post-trade: 'Ladd McConkey was an instrumental figure throughout the entire season, and will always be remembered as one of the WR1s our young core was made of to compete. Good luck, Ladd, in all your future endeavors.'",
    teamIds: [5, 8],
  },
 {
    id: 7,
  date: '2026-07-01',
    category: 'ROSTER MOVE',
    title: "The Scranton Silly Guys make a roster cut.",
    excerpt: 'The Scranton Silly Guys have made a roster move involving a defensive unit.',
    image: 'https://static.clubs.nfl.com/image/upload/t_landscape_tablet/vikings/ad4j7kwhliupgtnpm4pi.png',
    body: "The Scranton Silly Guys have cut the Minnesota Vikings DEF. \n They started 8 games, notably in the Prison Flag Bowl defeat, providing 35 points that simply weren't enough, though not their fault, to get ahead of the Olympians. \n This comes after they acquired the Denver Broncos DEF in an earlier trade with the InshallArtetaliban.",
    teamIds: [5],
  },
 {
    id: 8,
  ...
  },
 {
  ...
  date: '2026-07-01',
    category: 'ROSTER MOVE',
    title: "The Scranton Silly Guys make two roster cuts.",
    excerpt: 'The Scranton Silly Guys have made two roster moves this afternoon.',
    image: 'https://static.toiimg.com/thumb/msid-124280556,width-1280,height-720,resizemode-4/124280556.jpg',
    body: "The Scranton Silly Guys have cut TE Jake Tonges and WR Jakobi Meyers. Tonges did not play a single game for the Silly Guys after being resigned by the Sillies in the offseason. Jakobi Meyers, on the other hand, started 11 games for the Silly Guys, posting an 11.5 point per week average. \n\n Meyers is expected to be picked up on the waiver wire by a team.",
    teamIds: [5],
  },
 {
    id: 10,
  date: '2026-07-01',
    category: 'ROSTER MOVE',
    title: "The InshallArtetaliban make two signings.",
    excerpt: 'The InshallArtetaliban have also made two roster moves this afternoon.',
    image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQfAQmctNCjoppZCZjiKvW6ixWjfy7OUHLb1LjpvMdu1ym5AYOKRdchy16AOc_cZwUs4aK3sjhOQ0MxaqAv52VMjyF9R_ok42QtJLL42Lg&s=10',
    body: "The InshallArtetaliban have re-signed WR Jayden Reed off of waivers. Reed was on the Talibanis after being drafted in the seventeenth round of the 2025 #CTESPN Draft, remaining injured for most of the season, and was released in week 7. \n\n In a corresponding move, the Talibanis also re-signed Cade Otton. Otton was drafted in the 24th round of the 2025 #CTESPN Draft and released in week 1 by Scranton. The Talibanis then picked him up in week 7, and he was released in week 16.",
    teamIds: [8],
  },
 {
    id: 11,
  date: '2026-07-01',
    category: 'ROSTER MOVE',
    title: "Hongyuan cut two players.",
    excerpt: 'The Heishous make two cuts today, in a very active evening for the league.',
    image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRZbygzIJY82E7TcCVSUPBHC0-JYpMGgebK_M5THxnebnAf3QhfHB2PX38&s=10',
    body: "Hongyuan Heishous have cut TE David Njoku. Njoku was picked up in the fifteenth round by God, Syria, and Allar, and then released after the draft. He was picked off waivers by the InshallArtetaliban and traded to the Ta Keo Titans, all before Week 1. He was released from the Titans in Week 16, and had been signed twice by the Heishous since free agency started in April. He is expected to have some interest this offseason. \n\n The Heishous also cut free-agency signing RB Marshawn Lloyd. He will likely not garner any interest this offseason.",
    teamIds: [6],
  },
 {
    id: 12,
  date: '2026-07-02',
    category: 'ROSTER MOVE',
    title: "The InshallArtetaliban sign a QB.",
    excerpt: 'The Talibanis make another addition to their QB room.',
    image: 'https://images2.minutemediacdn.com/image/upload/c_crop,x_1488,y_0,w_2832,h_1593/c_fill,w_720,ar_16:9,f_auto,q_auto,g_auto/images/ReutersImages/mmsport/47/01kxbpgggdmgksmdsgxk.jpg',
    body: "The Talibanis have signed QB Anthony Richardson for the duration of training camp. He is the fourth quarterback on this roster, and will likely be released at the beginning of the season.",
    teamIds: [8],
  },
 {
    id: 13,
  date: '2026-07-04',
    category: 'ROSTER MOVE',
    title: "The InshallArtetaliban sign a WR off waivers.",
    excerpt: 'The Talibanis sign WR Jakobi Meyers off waivers.',
    image: 'https://a.espncdn.com/photo/2025/1015/r1560692_1296x729_16-9.jpg',
    body: "The Talibanis have signed WR Jakobi Meyers off waivers after being released by the Scranton Silly Guys earlier this week. This comes as a useful addition to have a WR with starting experience for his previous team. He is expected to sit atop the depth chart alongside Tetairoa McMillan.",
    teamIds: [8],
  },
 {
    id: 14,
  date: '2026-07-08',
    category: 'TRADE',
    title: "Ta Keo trade for the fifth overall pick.",
    excerpt: 'The Titans and Heishous have come to an agreement for a large trade between both sides.',
    image: 'https://static.clubs.nfl.com/image/upload/t_editorial_landscape_12_desktop/jets/ndnpqnmyzx0wi6eb0ufv',
    body: "The Ta Keo Titans have traded with the Hongyuan Heishous. They send Jets WR Garrett Wilson and a 2027 2nd round pick (via OLY) in exchange for Broncos WR Courtland Sutton, Titans RB Tony Pollard, and the fifth overall pick in the 2026 #CTESPN Draft.",
    teamIds: [5,6],
  },
 {
    id: 15,
  date: '2026-07-09',
    ...
    title: "The Talibanis have placed a player on the trade block.",
    excerpt: 'The InshallArtetaliban have placed a superstar on the trade block.',
    image: 'https://www.ozarksfirst.com/wp-content/uploads/sites/65/2024/09/66dccc191c9544.36286797.jpeg?w=2560&h=1440&crop=1',
    body: "The InshallArtetaliban are allegedly hearing out offers for star RB Christian McCaffrey, despite being the #1 overall non-QB in fantasy last season. McCaffrey started all 17 games for the Talibanis, being an instrumental figure to the team alongside Bijan Robinson. This raises questions as to whether they want to rebuild or contend this season after narrowly missing out on the playoffs last season, instead placing 5th by winning the Charlie Kirk Bowl.",
    teamIds: [8],
  },
